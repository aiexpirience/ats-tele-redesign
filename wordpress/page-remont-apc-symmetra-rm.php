<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-symmetra-rm.php
 * Template Name: Ремонт Symmetra RM
 */
/*
 * Template Name: Ремонт Symmetra RM
 */
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · Symmetra RM</div>
        <h1>РЕМОНТ<br><span>APC Symmetra RM</span></h1>
        <p class="page-hero-desc">Стоечные модульные источники бесперебойного питания Symmetra RM в форм-факторе 2U–12U. Ремонт модулей питания, замена батарей, восстановление интерфейсных плат.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Ремонт и диагностика силового модуля</span><strong>APC SYPM2KU</strong></li>
<li><span>Ремонт и диагностика модуля управления</span><strong>APC SYMIM3</strong></li>
<li><span>Ремонт и диагностика резервного модуля управления</span><strong>APC SYRIM3</strong></li>
<li><span>Замена аккумуляторных батарей</span><strong>APC SYBT2</strong></li>
<li><span>Диагностика, обслуживание фрейма ИБП</span><strong>SYMMETRA RM</strong></li>
<li><span>Диагностика, обслуживание батарейного фрейма</span><strong>APC SYRMXR4I</strong></li>
<li><span>Диагностика и ремонт платы расширения</span><strong>APC SYXRCC</strong></li>
</ul>
...
<a href="<?php echo home_url('/remont-apc-symmetra-rm/'); ?>" class="rel-pill active">APC Symmetra RM</a>
