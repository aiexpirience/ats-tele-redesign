<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-symmetra-lx.php
 * Template Name: Ремонт Symmetra LX
 */
/*
 * Template Name: Ремонт Symmetra LX
 */
...
:root{--bg:#f8f7f3;--bg2:#fff;--card:#fff;--card2:#f0ede6;--border:#e5e1d8;--accent:#1565C0;--accent-h:#0D47A1;--accent-bg:rgba(21,101,192,.10);--accent-bd:rgba(21,101,192,.30);--mag:#1565C0;--mag-bg:rgba(34,158,217,.08);--mag-bd:rgba(34,158,217,.24);--navy:#2D3748;--green:#1565C0;--text:#1c2030;--text2:#4a5568;--text3:#8a93a8;--shadow-sm:0 2px 8px rgba(45,55,72,.07);--shadow:0 4px 24px rgba(45,55,72,.10);--radius:12px;--nav-h:72px;--max-w:1240px;color-scheme:light;--surface:var(--bg2);--surface2:var(--card2)}
...
.seo-hero-bg{
  ...
  background:
    linear-gradient(to right, rgba(245,243,238,1) 35%, rgba(245,243,238,0.65) 60%, rgba(245,243,238,0.2) 100%),
    linear-gradient(to bottom, rgba(245,243,238,0.9) 0%, rgba(245,243,238,0.55) 100%),
    url('https://images.unsplash.com/photo-1518770660439-4636190af475?w=1400&q=85&auto=format&fit=crop') center/cover no-repeat;
  pointer-events:none;
}
[data-theme="dark"] .seo-hero-bg{
  background:
    linear-gradient(to right, rgba(12,16,24,1) 40%, rgba(12,16,24,0.65) 65%, rgba(12,16,24,0.2) 100%),
    url('https://images.unsplash.com/photo-1518770660439-4636190af475?w=1400&q=85&auto=format&fit=crop') center/cover no-repeat;
}
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · Symmetra LX</div>
        <h1>РЕМОНТ<br><span>APC Symmetra LX</span></h1>
        <p class="page-hero-desc">Модульные источники бесперебойного питания Symmetra LX мощностью 4–16 кВА. Ремонт и замена силовых модулей, модулей байпаса, батарейных модулей. Нагрузочное тестирование.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Ремонт и диагностика силового модуля</span><strong>APC SYPM4KI</strong></li>
<li><span>Ремонт и диагностика интеллектуального модуля управления</span><strong>APC SYMIM5</strong></li>
<li><span>Обновление микропрограммы батарейного модуля</span><strong>APC SYBT5</strong></li>
<li><span>Замена аккумуляторных батарей в батарейном модуле</span><strong>APC SYBT5</strong></li>
<li><span>Диагностика, обслуживание фрейма ИБП</span><strong>SYMMETRA LX</strong></li>
<li><span>Диагностика, обслуживание батарейного фрейма</span><strong>APC SYBFXR9RMI и др.</strong></li>
<li><span>Диагностика и ремонт платы расширения</span><strong>APC SYASFU16</strong></li>
</ul>
      ...
      <div class="seo-sidebar">
        <div class="sidebar-card">
          ...
          <div class="sidebar-price">от 8 000 ₽</div>
  ...
  <section class="section" style="padding-top:48px;padding-bottom:64px">
    ...
    <div class="related-pills"><a href="<?php echo home_url('/remont-apc-symmetra-lx/'); ?>" class="rel-pill active">APC Symmetra LX</a>
