...
[data-theme="dark"] .section-desc{color:var(--text2)}
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>Выкуп оборудования · Санкт-Петербург</div>
        <h1>ВЫКУП<br><span>источников бесперебойного питания</span></h1>
        <p class="page-hero-desc">Выкупаем рабочие и нерабочие источники бесперебойного питания, серверное и телекоммуникационное оборудование. Оценка бесплатно, расчёт в день обращения. Выезд к вам или привозите сами.</p>
      ...
      <div class="phstat">
        <div class="phstat-num">день в день</div>
        <div class="phstat-label">оценка и расчёт</div>
      </div>
      <div class="phstat">
        <div class="phstat-num"><span>0</span> руб.</div>
        <div class="phstat-label">бесплатная оценка</div>
      </div>
      <div class="phstat">
        <div class="phstat-num">любое</div>
        <div class="phstat-label">состояние техники</div>
      </div>
      </div>
    </div>
  </div>
...
<section class="section">
  <div class="section-hd"><div class="accent-bar"></div><p class="eyebrow">Как это работает</p><h2 class="display" style="font-size:clamp(22px,3vw,42px);margin-bottom:12px">3 ШАГА ДО ПРОДАЖИ</h2></div>
  <div class="grid-3">
    <div class="card" style="text-align:center"><div style="width:48px;height:48px;border-radius:50%;background:var(--accent);color:#fff;font-weight:800;font-size:20px;display:inline-flex;align-items:center;justify-content:center;margin-bottom:16px;box-shadow:0 4px 14px rgba(30,136,229,.35)">1</div><div class="card-title">Опишите оборудование</div><div class="card-text">Позвоните или напишите в Telegram. Укажите марку, модель, состояние - по фото или описанию.</div></div>
    <div class="card" style="text-align:center"><div style="width:48px;height:48px;border-radius:50%;background:var(--accent);color:#fff;font-weight:800;font-size:20px;display:inline-flex;align-items:center;justify-content:center;margin-bottom:16px;box-shadow:0 4px 14px rgba(30,136,229,.35)">2</div><div class="card-title">Получите оценку</div><div class="card-text">Оцениваем в течение 1 часа. Называем цену сразу - без расплывчатых "приедем - посмотрим".</div></div>
    <div class="card" style="text-align:center"><div style="width:48px;height:48px;border-radius:50%;background:var(--accent);color:#fff;font-weight:800;font-size:20px;display:inline-flex;align-items:center;justify-content:center;margin-bottom:16px;box-shadow:0 4px 14px rgba(30,136,229,.35)">3</div><div class="card-title">Получите деньги</div><div class="card-text">Выезжаем и забираем сами. Расчёт в день сделки — сразу при передаче оборудования.</div></div>
  </div>
</section>
<div class="divider"></div>
<section class="section">
  <div class="section-hd"><div class="accent-bar"></div><p class="eyebrow">Что выкупаем</p><h2 class="display" style="font-size:clamp(22px,3vw,42px);margin-bottom:12px">ПРИНИМАЕМ ВСЁ</h2></div>
  <div class="grid-3">
    <div class="card"><div class="card-ico">🔋</div><div class="card-title">ИБП любых марок</div><div class="card-text">APC, Eaton, Riello, Штиль, CyberPower и другие. Рабочие и нерабочие, любой мощности.</div></div>
    <div class="card"><div class="card-ico">📞</div><div class="card-title">Офисные АТС</div><div class="card-text">Panasonic, Avaya, Cisco, NEC, Samsung. Системы с комплектом телефонов и без.</div></div>
    <div class="card"><div class="card-ico">🌐</div><div class="card-title">Сетевое оборудование</div><div class="card-text">Коммутаторы, маршрутизаторы, точки доступа. Cisco, Mikrotik, HP, D-Link.</div></div>
  </div>
</section>
<div class="divider"></div>
<div style="max-width:var(--max-w);margin:0 auto;padding:56px 32px 80px"><div class="cta-band"><div class="cta-text"><h2 class="display">ПРОДАТЬ ОБОРУДОВАНИЕ?</h2><p class="lead">Пришлите фото и модель в Telegram - оценим за 1 час.</p></div><div class="cta-actions"><a href="tel:+79046490909" class="btn btn-lg" style="background:var(--accent);color:white">📞 Позвонить</a><a href="https://t.me/atstelecom" target="_blank" rel="noopener noreferrer" class="btn btn-lg" style="background:#229ED9;color:white"><svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg></a></div></div></div>
</div><?php get_footer(); ?>
