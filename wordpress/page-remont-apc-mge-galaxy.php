<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-mge-galaxy.php
 * Template Name: Ремонт MGE Galaxy
 */
/*
 * Template Name: Ремонт MGE Galaxy
 */
...
.seo-hero-bg{
  ...
  background:
    ...
    url('https://images.unsplash.com/photo-1573164713988-8665fc963095?w=1400&q=85&auto=format&fit=crop') center/cover no-repeat;
  pointer-events:none;
}
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · MGE Galaxy</div>
        <h1>РЕМОНТ<br><span>APC MGE Galaxy</span></h1>
        <p class="page-hero-desc">Трёхфазные источники бесперебойного питания промышленного класса серий 3500, 5500, 7000 и 9000. Компонентный ремонт с нагрузочным тестированием для дата-центров и производственных объектов.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Диагностика и ремонт серий</span><strong>Galaxy 3500, 5500, 7000, 9000</strong></li>
<li><span>Ремонт силовых плат, инверторов и выпрямителей</span></li>
<li><span>Замена аккумуляторных батарей и батарейных кабинетов</span></li>
<li><span>Ремонт плат управления и мониторинга</span></li>
<li><span>Обновление прошивки, настройка рабочих параметров</span></li>
<li><span>Нагрузочное тестирование после ремонта</span></li>
</ul>
      ...
      <div class="seo-sidebar">
        <div class="sidebar-card">
          ...
          <div class="sidebar-price">от 10 000 ₽</div>
...
<a href="<?php echo home_url('/remont-apc-mge-galaxy/'); ?>" class="rel-pill active">APC MGE Galaxy</a>
