<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-ibp-apc.php
 * Template Name: Ремонт APC
 */
/*
 * Template Name: Ремонт APC
 */
...
[data-theme="dark"] .section-desc{color:var(--text2)}
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>Ремонт · APC by Schneider Electric</div>
        <h1>РЕМОНТ<br><span>источников бесперебойного питания APC</span></h1>
        <p class="page-hero-desc">Компонентный ремонт источников бесперебойного питания APC by Schneider Electric всех серий и мощностей. Собственный склад запчастей, ремонт в день обращения, письменная гарантия.</p>
...
<section class="section">
  <div class="section-hd">
    ...
    <h2 class="display" style="font-size:clamp(22px,3vw,42px);margin-bottom:12px">СЕРИИ APC</h2>
    <p class="lead" style="font-size:15px;max-width:640px">Ремонтируем всю линейку APC by Schneider Electric - от бюджетного Back-UPS до промышленного Symmetra PX 500 кВА. Диагностика бесплатна при ремонте.</p>
  </div>
  <div class="grid-3">
    <a href="<?php echo home_url('/remont-apc-smart-ups/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">🔋</div><div class="card-title">APC Smart-UPS (SMT/SMX/SUA)</div><div class="card-text">Самая распространённая серия. 500 ВА–5 кВА. Ремонт зарядного устройства, инвертора, платы управления. Замена батарей RBC.</div><div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:8px">→ от 2 500 ₽</div></div></a>
    <a href="<?php echo home_url('/remont-apc-srt/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">🔋</div><div class="card-title">APC Smart-UPS SRT (1–20 кВА)</div><div class="card-text">Высокоэффективный онлайн ИБП с конфигурируемыми розетками. Ремонт инвертора, зарядного модуля, замена SRT192BP.</div><div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:8px">→ от 5 000 ₽</div></div></a>
    <a href="<?php echo home_url('/remont-apc-surt-surtd/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">🔋</div><div class="card-title">APC Smart-UPS RT (SURT/SURTD)</div><div class="card-text">Стоечный онлайн ИБП 1–10 кВА. Ремонт силовой части, платы управления. Замена внешних батарейных модулей.</div><div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:8px">→ от 5 000 ₽</div></div></a>
    <a href="<?php echo home_url('/remont-apc-symmetra-lx/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">⚡</div><div class="card-title">APC Symmetra LX (4–16 кВА)</div><div class="card-text">Модульный однофазный ИБП. Ремонт силовых модулей SYPM4KI, батарейных модулей SYBT5, блока управления.</div><div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:8px">→ от 10 000 ₽</div></div></a>
    <a href="<?php echo home_url('/remont-apc-symmetra-px/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">⚡</div><div class="card-title">APC Symmetra PX (40–500 кВА)</div><div class="card-text">Трёхфазный ЦОД-ИБП. Ремонт и замена силовых модулей, системы управления, байпасного модуля. Выезд на объект.</div><div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:8px">→ от 25 000 ₽</div></div></a>
    <a href="<?php echo home_url('/remont-apc-mge-galaxy/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">⚡</div><div class="card-title">APC MGE Galaxy (3500–9000)</div><div class="card-text">Промышленные трёхфазные ИБП 10–120 кВА. Ремонт IGBT-инверторов, силовых плат, модулей связи.</div><div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:8px">→ от 15 000 ₽</div></div></a>
  </div>
  <div style="margin-top:16px;padding:16px 20px;background:var(--card2);border-radius:12px;font-size:13px;color:var(--text2)">
    Также ремонтируем: <a href="<?php echo home_url('/remont-apc-symmetra-rm/'); ?>" style="color:var(--accent)">Symmetra RM</a> · <a href="<?php echo home_url('/remont-apc-symmetra-vt/'); ?>" style="color:var(--accent)">Symmetra VT</a> · Back-UPS (BE, BX, BR) · Smart-UPS XL · Smart-UPS VT · Silcon
  </div>
</section>
  ...
  <div class="grid-2">
    <div>
      ...
      <div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
        ...
        <div>
          <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Износ аккумуляторных батарей (RBC)</div>
          <div style="font-size:13px;color:var(--text3);line-height:1.6">Самая частая причина обращений. Пищит, мигает индикатор замены, ИБП не держит нагрузку. Заменяем оригинальные и совместимые батареи: CSB, EnerSys, FIAMM.</div>
          <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Замена АКБ от 2 500 ₽</div>
        </div>
      </div>
      <div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
        <div style="font-size:24px;flex-shrink:0">⚡</div>
        <div>
          <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Неисправность инвертора и силовых ключей</div>
          <div style="font-size:13px;color:var(--text3);line-height:1.6">ИБП уходит на байпас, на дисплее ошибки инвертора. Характерно для Smart-UPS SMT/SMX/SRT при перегрузках или скачках сети. Замена IGBT и MOSFETs.</div>
          <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Ремонт инвертора от 6 000 ₽</div>
        </div>
      </div>
      <div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
        <div style="font-size:24px;flex-shrink:0">🌡️</div>
        <div>
          <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Неисправность зарядного устройства</div>
          <div style="font-size:13px;color:var(--text3);line-height:1.6">Батареи не заряжаются, горит индикатор Replace Battery через короткое время после замены АКБ. Ремонт зарядного модуля - частый вид работ по Smart-UPS.</div>
          <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Ремонт зарядного от 4 500 ₽</div>
        </div>
      </div>
      <div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
        <div style="font-size:24px;flex-shrink:0">🖥️</div>
        <div>
          <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Вздутые конденсаторы и ложные аварии</div>
          <div style="font-size:13px;color:var(--text3);line-height:1.6">Ложные отключения, шум вентилятора, нестабильное выходное напряжение. Профилактическая замена электролитических конденсаторов продлевает жизнь ИБП на 5–7 лет.</div>
          <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Профилактика от 3 500 ₽</div>
        </div>
      </div>
      <div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
        <div style="font-size:24px;flex-shrink:0">📟</div>
        <div>
          <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Неисправность платы управления</div>
          <div style="font-size:13px;color:var(--text3);line-height:1.6">ИБП не включается, не выходит на связь с APC PowerChute по USB, дисплей не работает. Ремонт или перепрошивка платы управления, замена дисплея.</div>
          <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Ремонт платы от 4 000 ₽</div>
        </div>
      </div>
    </div>
    <div>
      ...
      <div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
        ...
        <div><div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Приём и осмотр</div><div style="font-size:13px;color:var(--text3);line-height:1.6">Принимаем ИБП в сервисе или выезжаем. Для Symmetra и Galaxy - выезд инженера с диагностическим оборудованием.</div></div>
      </div>
      <div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
        ...
        <div><div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Бесплатная диагностика</div><div style="font-size:13px;color:var(--text3);line-height:1.6">Нагрузочный тест, проверка батарей мультиметром и специализированным тестером, осмотр электроники, код ошибки по APC EventLog.</div></div>
      </div>
      <div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
        ...
        <div><div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Согласование стоимости</div><div style="font-size:13px;color:var(--text3);line-height:1.6">Называем точную стоимость до начала работ. Только после вашего согласия приступаем к ремонту.</div></div>
      </div>
      <div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
        ...
        <div><div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Компонентный ремонт</div><div style="font-size:13px;color:var(--text3);line-height:1.6">Ремонт на уровне элементной базы. Собственная паяльная станция, стенд нагрузочного теста. Используем оригинальные компоненты и проверенные аналоги.</div></div>
      </div>
      <div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
        ...
        <div><div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Тест и гарантия</div><div style="font-size:13px;color:var(--text3);line-height:1.6">Нагрузочный тест 15–30 минут, проверка всех режимов. Выдаём с гарантийным талоном и актом выполненных работ.</div></div>
      </div>
      <div style="margin-top:24px;padding:20px;background:var(--accent-bg);border-radius:14px;border:1.5px solid var(--accent-bd)">
        ...
        <div style="font-size:13px;color:var(--text2);line-height:1.6">При наличии запчастей на складе - ремонт в день обращения. Пока ваш ИБП на ремонте - <a href="<?php echo home_url('/rent/'); ?>" style="color:var(--accent)">арендуйте подменный</a>.</div>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="section-hd">
    ...
    <h2 class="display" style="font-size:clamp(22px,3vw,42px);margin-bottom:12px">ВОПРОСЫ О РЕМОНТЕ APC</h2>
  </div>
  <div style="max-width:760px">
    <div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
      <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
        <span>Сколько стоит ремонт APC Smart-UPS?</span><span style="color:var(--accent);font-size:18px">▾</span>
      </div>
      <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Стоимость зависит от модели и характера неисправности. Замена АКБ для SMT - от 2 500 ₽. Ремонт Smart-UPS - от 4 000 ₽. Ремонт Symmetra LX - от 10 000 ₽, Symmetra PX - от 25 000 ₽. Диагностика бесплатна при ремонте.</p></div>
    </div>
    <div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
      <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
        <span>Есть ли запчасти для APC Smart-UPS и Symmetra?</span><span style="color:var(--accent);font-size:18px">▾</span>
      </div>
      <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да, держим склад запчастей для APC: батареи RBC-совместимые, конденсаторы, IGBT, платы управления Smart-UPS и модули Symmetra. Большинство ремонтов - в день обращения.</p></div>
    </div>
    <div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
      <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
        <span>Даёте ли гарантию на ремонт APC?</span><span style="color:var(--accent);font-size:18px">▾</span>
      </div>
      <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да. На ремонтные работы - 6 месяцев. На замену АКБ - 12 месяцев. На замену модулей Symmetra - 6 месяцев. Гарантийный талон выдаётся с актом.</p></div>
    </div>
    <div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
      <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
        <span>Ремонтируете ли вы APC, если он не включается?</span><span style="color:var(--accent);font-size:18px">▾</span>
      </div>
      <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да. Частые причины: глубокий разряд батарей (Smart-UPS не стартует без батарей), неисправность платы управления, отказ входного фильтра. Диагностика показывает причину - ремонт возможен в большинстве случаев.</p></div>
    </div>
    <div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
      <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
        <span>Выезжаете ли на объект для ремонта APC Symmetra?</span><span style="color:var(--accent);font-size:18px">▾</span>
      </div>
      <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да, для Symmetra PX, Galaxy и другого тяжёлого промышленного оборудования выезжаем на объект по СПб и ЛО. Уточните условия по телефону или в Telegram.</p></div>
    </div>
  </div>
</section>
...
<div style="max-width:1240px;margin:0 auto;padding:0 32px 56px">
  <div style="background:var(--navy);border-radius:24px;padding:48px;display:flex;align-items:center;gap:20px;position:relative;overflow:hidden">
    ...
    <div style="flex:1;position:relative">
      <h2 class="display" style="font-size:clamp(24px,3vw,40px);color:white">НУЖЕН РЕМОНТ APC?</h2>
      <p class="lead" style="color:rgba(255,255,255,.6);margin-top:8px">Привезите ИБП к нам или вызовите инженера. Диагностика - бесплатно при ремонте.</p>
    </div>
    <div style="display:flex;gap:12px;flex-wrap:wrap;flex-shrink:0;position:relative">
      ...
      <a href="https://t.me/atstelecom" target="_blank" rel="noopener noreferrer" class="btn btn-lg" style="background:#229ED9;color:white"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg></a>
    </div>
  </div>
</div>
