<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-symmetra-vt.php
 * Template Name: Ремонт Symmetra VT
 */
/*
 * Template Name: Ремонт Symmetra VT
 */
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · Symmetra VT</div>
        <h1>РЕМОНТ<br><span>APC Symmetra VT</span></h1>
        <p class="page-hero-desc">Трёхфазные источники бесперебойного питания Symmetra VT мощностью 10–40 кВА для средних и крупных объектов. Ремонт входных и выходных силовых блоков, систем охлаждения.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Диагностика и ремонт силовых модулей VT</span></li>
<li><span>Ремонт модулей управления и мониторинга</span></li>
<li><span>Замена аккумуляторных батарей и батарейных кабинетов</span></li>
<li><span>Обслуживание шкафов и стоек расширения</span></li>
<li><span>Ремонт входных и выходных модулей</span></li>
...
<a href="<?php echo home_url('/remont-apc-symmetra-vt/'); ?>" class="rel-pill active">APC Symmetra VT</a>
