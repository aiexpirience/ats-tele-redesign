<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-symmetra-px.php
 * Template Name: Ремонт Symmetra PX
 */
/*
 * Template Name: Ремонт Symmetra PX
 */
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · Symmetra PX</div>
        <h1>РЕМОНТ<br><span>APC Symmetra PX</span></h1>
        <p class="page-hero-desc">Масштабируемые трёхфазные источники бесперебойного питания Symmetra PX мощностью 10–500 кВА. Ремонт силовых и батарейных модулей, замена трансформаторов, настройка параметров.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Ремонт силового модуля до 40 кВт</span><strong>SYPM10KH</strong></li>
<li><span>Ремонт силового модуля 48–160 кВт</span><strong>SYPM10K16H</strong></li>
<li><span>Ремонт силового модуля 250/500 кВт с обнулением наработки</span><strong>SYPM25KD</strong></li>
<li><span>Ремонт модулей управления</span><strong>SYMIM4, SYMIM16, SYRIM2</strong></li>
<li><span>Ремонт статик свитча</span><strong>SYSW40KH, SYSW48KH, SYSW160KH, SYSW250KD, SYSW500KD</strong></li>
<li><span>Замена батарейных модулей</span><strong>SYBTU1-PLP, SYBTU2-PLP</strong></li>
<li><span>Обслуживание фреймов и всех комплектующих</span><strong>бекплейн, AP9643, AP9635, SYOPT007, SYOPT008</strong></li>
</ul>
      ...
      <div class="seo-sidebar">
        <div class="sidebar-card">
          ...
          <div class="sidebar-price">от 15 000 ₽</div>
...
<a href="<?php echo home_url('/remont-apc-symmetra-px/'); ?>" class="rel-pill active">APC Symmetra PX</a>
