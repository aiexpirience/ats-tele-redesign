<?php
/**
 * АТС ТЕЛЕКОМ — page-zamena-akb-ibp.php
 * Template Name: Замена АКБ ИБП
 */
/*
 * Template Name: Замена АКБ ИБП
 */
...
.hero{min-height:60vh;display:flex;align-items:center;position:relative;overflow:hidden;padding:0 32px;
  background:
    ...
    url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1400&q=85&auto=format&fit=crop') center/cover no-repeat;
}
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>Замена аккумуляторов · Санкт-Петербург</div>
        <h1>ЗАМЕНА АККУМУЛЯТОРОВ<br><span>в источниках бесперебойного питания</span></h1>
        <p class="page-hero-desc">Замена аккумуляторных батарей в источниках бесперебойного питания любых марок. Оригинальные и совместимые батареи на складе, выезд на объект, утилизация старых аккумуляторов.</p>
      ...
      <div class="phstat">
        <div class="phstat-num">в день</div>
        <div class="phstat-label">обращения</div>
      </div>
      <div class="phstat">
        <div class="phstat-num">все марки</div>
        <div class="phstat-label">источников</div>
      </div>
      <div class="phstat">
        <div class="phstat-num">утилизация</div>
        <div class="phstat-label">старых батарей</div>
      </div>
      </div>
    </div>
  </div>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Замена АКБ в ИБП мощностью от 600 ВА до 160 кВт</span></li>
<li><span>Кассеты и батарейные блоки APC</span><strong>RBC2, RBC7, RBC17, RBC44, RBC48, RBC123, RBC124, APCRBC115</strong></li>
<li><span>Батарейные модули Symmetra</span><strong>SYBT2, SYBT5, SYBTU1-PLP, SYBTU2-PLP</strong></li>
<li><span>АКБ для ИБП Eaton, CyberPower, Ippon, Штиль</span></li>
<li><span>Калибровка ИБП после замены батарей</span></li>
...
<a href="<?php echo home_url('/zamena-akb-ibp/'); ?>" class="rel-pill active">Замена АКБ</a>
