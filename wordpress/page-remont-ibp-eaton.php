<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-ibp-eaton.php
 * Template Name: Ремонт Eaton
 */
/*
 * Template Name: Ремонт Eaton
 */
...
.rel-pill:hover,.rel-pill.active{border-color:var(--accent-bd);color:var(--accent);background:var(--accent-bg)}
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>Ремонт · Eaton</div>
        <h1>РЕМОНТ<br><span>источников бесперебойного питания Eaton</span></h1>
        <p class="page-hero-desc">Компонентный ремонт источников бесперебойного питания Eaton серий 5SC, 5PX, 9SX, 9PX, 93E и других. Быстрая диагностика, собственный склад запчастей, письменная гарантия на все виды работ.</p>
...
<section class="section">
  <div class="section-hd">
    ...
    <h2 class="display" style="font-size:clamp(22px,3vw,42px);margin-bottom:12px">СЕРИИ EATON</h2>
    <p class="lead" style="font-size:15px;max-width:640px">Ремонтируем все серии Eaton - от офисных однофазных до промышленных трёхфазных систем. Диагностика бесплатно при ремонте.</p>
  </div>
  <div class="grid-3"><div class="card"><div class="card-ico">🔋</div><div class="card-title">Eaton 9PX (750 ВА–22 кВА)</div><div class="card-text">Онлайн ИБП для серверных комнат. Высокочастотный двойной конвертор. Ремонт IGBT, конденсаторов, зарядных модулей.</div></div><div class="card"><div class="card-ico">🔋</div><div class="card-title">Eaton 9SX (700 ВА–11 кВА)</div><div class="card-text">Высокоэффективный онлайн ИБП. Ремонт платы управления, инвертора, замена вентиляторов.</div></div><div class="card"><div class="card-ico">🔋</div><div class="card-title">Eaton 9E / 9EX (1–20 кВА)</div><div class="card-text">Трёхфазный онлайн ИБП для среднего бизнеса. Ремонт силовых модулей, платы байпаса.</div></div><div class="card"><div class="card-ico">🔋</div><div class="card-title">Eaton 5P / 5SC (650–3000 ВА)</div><div class="card-text">Линейно-интерактивный ИБП. Замена АКБ, ремонт зарядного устройства и AVR-стабилизатора.</div></div><div class="card"><div class="card-ico">🔋</div><div class="card-title">Eaton Powerware 9130/9155</div><div class="card-text">Промышленные ИБП. Ремонт модулей усиления, инвертора, системы управления.</div></div><div class="card"><div class="card-ico">🔋</div><div class="card-title">Eaton 5E / Ellipse ECO</div><div class="card-text">Бюджетные и офисные серии. Замена аккумуляторов, ремонт инвертора и контроллера.</div></div></div>
</section>
  ...
  <div class="grid-2">
    <div>
      ...
      <div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
          ...
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Выход из строя силовых IGBT-транзисторов</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Характерно для 9PX и 9SX при перегрузках. ИБП уходит на байпас, на дисплее ошибка инвертора. Требует замены силовых ключей и проверки драйверов.</div>
          ...
          <div style="font-size:24px;flex-shrink:0">🔋</div>
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Износ аккумуляторных батарей</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Самая частая причина обращений. ИБП пищит, индикатор замены батарей, сокращение времени автономии. Замена АКБ восстанавливает работу полностью.</div>
          ...
          <div>
            ...
            <div style="font-size:13px;color:var(--text3);line-height:1.6">ИБП не включается, зависает, не выходит на связь по USB/RS232. Может потребовать перепрошивки или замены контроллера.</div>
            <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Ремонт платы от 5 500 ₽</div>
          </div>
        </div><div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
          <div style="font-size:24px;flex-shrink:0">⚡</div>
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Вздутие электролитических конденсаторов</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Типично для Eaton старше 7 лет. Нестабильная работа, ложные аварии, самоперезагрузки. Профилактическая замена конденсаторов.</div>
            <div style="font-size:12px;color:var(--accent);font-weight:700;margin-top:6px">→ Профилактика от 4 000 ₽</div>
          </div>
        </div><div style="display:flex;gap:16px;padding:16px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:12px;align-items:flex-start">
          <div style="font-size:24px;flex-shrink:0">🔋</div>
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Выход из строя вентиляторов охлаждения</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">ИБП перегревается, уходит в защиту, отключает инвертор. Замена вентиляторов - недорогой и быстрый ремонт.</div>
    ...
    <div>
      ...
      <div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
          ...
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Приём и осмотр</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Принимаем ИБП в офисе или выезжаем на место. Проводим внешний осмотр и первичную диагностику.</div>
          </div>
          ...
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Бесплатная диагностика</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Полное тестирование: нагрузочный тест, проверка батарей, осмотр электроники. Результат - детальный отчёт.</div>
          </div>
        </div><div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
          ...
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Согласование и оплата</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Называем точную стоимость до начала работ. Только после вашего согласия приступаем.</div>
          </div>
        </div><div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
          ...
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Ремонт</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Компонентный ремонт на собственном оборудовании. Используем оригинальные и совместимые запчасти.</div>
          </div>
        </div><div style="display:flex;align-items:flex-start;gap:16px;padding:18px;background:var(--card);border:1.5px solid var(--border);border-radius:12px;margin-bottom:10px">
          ...
          <div>
            <div style="font-weight:800;font-size:14px;color:var(--text);margin-bottom:4px">Проверка и выдача</div>
            <div style="font-size:13px;color:var(--text3);line-height:1.6">Нагрузочный тест после ремонта, гарантийный талон. Выдаём с актом выполненных работ.</div>
          </div>
        </div>
...
<section class="section">
  <div class="section-hd">
    ...
    <h2 class="display" style="font-size:clamp(22px,3vw,42px);margin-bottom:12px">ВОПРОСЫ О РЕМОНТЕ EATON</h2>
  </div>
  <div style="max-width:760px"><div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
        <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
          <span>Сколько стоит ремонт Eaton 9PX 3000?</span><span style="color:var(--accent);font-size:18px">▾</span>
        </div>
        <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Стоимость зависит от характера неисправности. Замена АКБ - от 4 500 ₽. Ремонт инвертора - от 9 000 ₽. Диагностика бесплатна при ремонте. Уточните по телефону или в Telegram.</p></div>
      </div><div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
        <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
          <span>Есть ли в наличии запчасти для Eaton?</span><span style="color:var(--accent);font-size:18px">▾</span>
        </div>
        <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да, у нас собственный склад запчастей для Eaton 9PX, 9SX, 5P. Это позволяет делать большинство ремонтов в день обращения, без ожидания поставки.</p></div>
      </div><div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
        <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
          <span>Даёте ли гарантию на ремонт Eaton?</span><span style="color:var(--accent);font-size:18px">▾</span>
        </div>
        <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да. На выполненные работы - 6 месяцев. На замену АКБ - 12 месяцев. Гарантийный талон выдаётся с актом выполненных работ.</p></div>
      </div><div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
        <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
          <span>Можно ли починить Eaton, если он вообще не включается?</span><span style="color:var(--accent);font-size:18px">▾</span>
        </div>
        <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да, это распространённая ситуация. Причин много: разряженные батареи, неисправность платы управления или силовой части. Диагностика покажет реальную причину. В большинстве случаев ремонт возможен.</p></div>
      </div><div style="border:1.5px solid var(--border);border-radius:14px;overflow:hidden;margin-bottom:10px">
        <div style="padding:18px 20px;font-weight:800;font-size:15px;cursor:pointer;display:flex;justify-content:space-between;align-items:center;background:var(--card)" onclick="var a=this.nextElementSibling;a.style.display=a.style.display==='none'?'block':'none'">
          <span>Выезжаете ли на объект для ремонта Eaton?</span><span style="color:var(--accent);font-size:18px">▾</span>
        </div>
        <div style="display:none;padding:0 20px 18px;background:var(--card)"><p style="font-size:14px;line-height:1.75;color:var(--text2);margin:0">Да, выезжаем по Санкт-Петербургу и ЛО для ИБП мощностью от 10 кВА - их сложно транспортировать. Уточните условия выезда по телефону.</p></div>
      </div></div>
</section>
...
<section class="section" style="padding-top:0">
  <div class="section-hd">
    <div class="accent-bar"></div>
    <p class="eyebrow">Другие производители</p>
    <h2 class="display" style="font-size:clamp(18px,2vw,28px);margin-bottom:8px">РЕМОНТИРУЕМ ТАКЖЕ</h2>
  </div>
  <div class="related-pills">
    <a href="<?php echo home_url('/remont-ibp-apc/'); ?>" class="rel-pill">Ремонт APC</a>
    <a href="<?php echo home_url('/remont-apc-smart-ups/'); ?>" class="rel-pill">APC Smart-UPS</a>
    <a href="<?php echo home_url('/remont-apc-srt/'); ?>" class="rel-pill">APC SRT</a>
    <a href="<?php echo home_url('/remont-apc-mge-galaxy/'); ?>" class="rel-pill">APC MGE Galaxy</a>
    <a href="<?php echo home_url('/remont-ibp-riello/'); ?>" class="rel-pill">Ремонт Riello</a>
    <a href="<?php echo home_url('/repair/'); ?>" class="rel-pill">Все марки ИБП</a>
  </div>
</section>
...
<div style="max-width:1240px;margin:0 auto;padding:0 32px 56px">
  <div style="background:var(--navy);border-radius:24px;padding:48px;display:flex;align-items:center;gap:20px;position:relative;overflow:hidden">
    ...
    <div style="flex:1;position:relative">
      <h2 class="display" style="font-size:clamp(24px,3vw,40px);color:white">НУЖЕН РЕМОНТ EATON?</h2>
