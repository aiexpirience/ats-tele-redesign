<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-srt.php
 * Template Name: Ремонт APC SRT
 */
/*
 * Template Name: Ремонт APC SRT
 */
...
.seo-hero-bg{
  ...
  background:
    ...
    url('https://images.unsplash.com/photo-1580063665421-3d4d9b7d4bbc?w=1400&q=85&auto=format&fit=crop') center/cover no-repeat;
  pointer-events:none;
}
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · Smart-UPS SRT</div>
        <h1>РЕМОНТ<br><span>APC Smart-UPS SRT</span></h1>
        <p class="page-hero-desc">Высококачественные источники бесперебойного питания серии SRT с онлайн-топологией и внешними батарейными блоками. Ремонт инверторов, зарядных устройств, блоков управления.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Ремонт Smart-UPS SRT</span><strong>1–20 кВА</strong></li>
<li><span>Замена аккумуляторных блоков</span><strong>SRT192BP и аналогов</strong></li>
<li><span>Ремонт инвертора и зарядного устройства</span></li>
<li><span>Диагностика и ремонт платы управления</span></li>
<li><span>Замена силовых конденсаторов и транзисторов IGBT</span></li>
<li><span>Нагрузочное тестирование после ремонта</span></li>
      ...
      <div class="seo-sidebar">
        <div class="sidebar-card">
          ...
          <div class="sidebar-price">от 3 000 ₽</div>
...
<a href="<?php echo home_url('/remont-apc-srt/'); ?>" class="rel-pill active">APC Smart-UPS SRT</a>
