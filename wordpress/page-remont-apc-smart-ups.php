<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-smart-ups.php
 * Template Name: Ремонт APC Smart-UPS
 */
/*
 * Template Name: Ремонт APC Smart-UPS
 */
...
.seo-hero-bg{
  ...
  background:
    ...
    url('https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1400&q=85&auto=format&fit=crop') center/cover no-repeat;
  pointer-events:none;
}
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · Smart-UPS</div>
        <h1>РЕМОНТ<br><span>APC Smart-UPS</span></h1>
        <p class="page-hero-desc">Наиболее распространённая серия источников бесперебойного питания для офисов и серверных. Ремонтируем все модели: 750, 1000, 1500, 2200, 3000 ВА. Замена батарей, плат управления, силовых модулей.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Ремонт и диагностика моделей</span><strong>SMC1000IC, SMC1500I-2U, SMT750RMI2UC, SMT750I, SMX1000I, SMX3000RMHV2U, SC620, SUA750I, SUA1500RMI2U</strong></li>
<li><span>Замена АКБ в кассетах</span><strong>RBC2, RBC17, RBC48, RBC106, RBC44, RBC123, RBC124, APCRBC115, SMX48RMBP2U, SMX120RMBP2U</strong></li>
<li><span>Обновление прошивки ИБП</span><strong>при наличии технической возможности</strong></li>
<li><span>Сброс наработки АКБ</span><strong>при наличии технической возможности</strong></li>
<li><span>Установка и обновление сетевых карт</span><strong>AP9630, AP9631, AP9640, AP9641, AP9617, AP9619</strong></li>
<li><span>Ремонт зарядного устройства, инвертора, платы управления</span></li>
</ul>
...
<a href="<?php echo home_url('/remont-apc-smart-ups/'); ?>" class="rel-pill active">APC Smart-UPS</a>
