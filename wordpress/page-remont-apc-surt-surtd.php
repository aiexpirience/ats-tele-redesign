<?php
/**
 * АТС ТЕЛЕКОМ — page-remont-apc-surt-surtd.php
 * Template Name: Ремонт APC SURT
 */
/*
 * Template Name: Ремонт APC SURT
 */
...
<div class="page-wrap">
  ...
  <div class="page-hero">
    ...
    <div class="page-hero-inner">
      <div>
        <div class="page-hero-badge"><span></span>APC by Schneider Electric · SURT / SURTD</div>
        <h1>РЕМОНТ<br><span>APC SURT / SURTD</span></h1>
        <p class="page-hero-desc">Промышленные источники бесперебойного питания серии SURT и SURTD мощностью 1–10 кВА. Ремонт силовой части, замена конденсаторов, восстановление платы управления.</p>
  ...
  <section class="section">
    <div class="seo-hero-grid">
      ...
      <div>
        ...
        <ul class="works-list"><li><span>Ремонт Smart-UPS RT серий SURT и SURTD</span><strong>1–10 кВА</strong></li>
<li><span>Диагностика и ремонт силовой части и инвертора</span></li>
<li><span>Замена внутренних и внешних аккумуляторных батарей</span></li>
<li><span>Ремонт плат управления и зарядных устройств</span></li>
<li><span>Замена вентиляторов и силовых конденсаторов</span></li>
<li><span>Нагрузочное тестирование, гарантийный акт</span></li>
      ...
      <div class="seo-sidebar">
        <div class="sidebar-card">
          ...
          <div class="sidebar-price">от 3 500 ₽</div>
...
<a href="<?php echo home_url('/remont-apc-surt-surtd/'); ?>" class="rel-pill active">APC SURT / SURTD</a>
