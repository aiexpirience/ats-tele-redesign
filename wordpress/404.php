...
:root{--bg:#f8f7f3;--bg2:#fff;--card:#fff;--card2:#f0ede6;--border:#e5e1d8;--accent:#1565C0;--accent-h:#0D47A1;--accent-bg:rgba(21,101,192,.10);--accent-bd:rgba(21,101,192,.30);--mag:#1565C0;--mag-bg:rgba(34,158,217,.08);--mag-bd:rgba(34,158,217,.24);--navy:#2D3748;--green:#1565C0;--text:#1c2030;--text2:#4a5568;--text3:#8a93a8;--shadow-sm:0 2px 8px rgba(45,55,72,.07);--shadow:0 4px 24px rgba(45,55,72,.10);--radius:12px;--nav-h:72px;--max-w:1240px;color-scheme:light}
...
.btn-outline{padding:12px 24px;border-radius:10px;border:2px solid var(--border2);color:var(--text2);font-weight:700;font-size:14px;transition:all .2s;display:inline-flex;align-items:center;gap:8px}
.btn-outline:hover{border-color:var(--accent);color:var(--accent)}

</style>
<?php if ($desc) echo '<meta name="description" content="' . esc_attr($desc) . '">'; ?>
<title>Страница не найдена  -  АТС ТЕЛЕКОМ</title>
</div>
<div class="page-wrap">
  <div style="min-height:70vh;display:flex;align-items:center;justify-content:center;padding:80px 32px">
    <div style="text-align:center;max-width:560px">
      <div style="font-family:'Inter',sans-serif;font-size:120px;font-weight:800;color:var(--accent);line-height:1;margin-bottom:16px">404</div>
      <div class="accent-bar" style="margin:0 auto 20px"></div>
      <h1 style="font-family:'Inter',sans-serif;font-size:clamp(22px,4vw,36px);font-weight:800;margin-bottom:16px">Страница не найдена</h1>
      <p style="font-size:16px;line-height:1.7;color:var(--text2);margin-bottom:32px">Возможно, ссылка устарела или страница была перемещена. Воспользуйтесь навигацией или перейдите на одну из популярных страниц.</p>
      <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;margin-bottom:40px">
        <a href="<?php echo home_url('/'); ?>" class="btn btn-primary btn-lg">🏠 На главную</a>
        <a href="<?php echo home_url('/repair/'); ?>" class="btn btn-outline btn-lg">🔧 Ремонт ИБП</a>
        <a href="<?php echo home_url('/contacts/'); ?>" class="btn btn-outline btn-lg">📞 Контакты</a>
      </div>
      <div class="grid-3" style="text-align:left">
        <a href="<?php echo home_url('/repair/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">🔧</div><div class="card-title">Ремонт ИБП</div><div class="card-text">Все бренды, все мощности. Бесплатная диагностика.</div></div></a>
        <a href="<?php echo home_url('/rent/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">📦</div><div class="card-title">Аренда ИБП</div><div class="card-text">От 3 дней, от 5 000 ₽. По договору.</div></div></a>
        <a href="<?php echo home_url('/zamena-akb-ibp/'); ?>" style="text-decoration:none"><div class="card"><div class="card-ico">🔋</div><div class="card-title">Замена АКБ</div><div class="card-text">Все модели ИБП. Гарантия 12 месяцев.</div></div></a>
      </div>
    </div>
  </div>
</div><?php get_footer(); ?>
